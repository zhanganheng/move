...
public class GengduoA_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    List<ACimemaBean.ResultBean> result;
     Context context;

    public GengduoA_Adapter(List<ACimemaBean.ResultBean> result, Context context) {
        this.result = result;
