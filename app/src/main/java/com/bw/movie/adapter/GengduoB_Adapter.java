...
public class GengduoB_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    List<BCinemaBean.ResultBean> result;
     Context context;

    public GengduoB_Adapter(List<BCinemaBean.ResultBean> result, Context context) {
        this.result = result;
        this.context = context;
    }

    public GengduoB_Adapter(List<CCinemaBean.ResultBean> result, FragmentActivity activity) {
    }
