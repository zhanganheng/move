...
public class Ticket_wait_Fragment extends BaseFragment<BuyTicketPresenter> implements BuyTickeyContract.Iview {
    ...
    protected int provideLayoutId() {
        return R.layout.fragment_ticket_wait_;
    }
    ...
    protected void initData() {
        ...
        mPresenter.buytickey(userId + "", sessionId, "1", "5", "1");
    }
    ...
    public void BuyTicketSuccess(BuyTicketBean buyTicketBean) {
        ...
        if (result != null) {
            ...
            cinemaRecycler.setAdapter(guan_cinema_adapter);
        } else {
